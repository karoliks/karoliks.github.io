export const projectdata = {
  recipeapp: {
    ...
    title: "Recipe Finder",
    desc:
      "Simple way to display and search for recipes. Created as a way to learn React.",
  ...
  exp: {
    ...
    title: "Gallery",
    desc:
      "A place to display some drawings I made a while back. Made to test out smooth scroll functions in JavaScript",
